...
- ported to python3 
- added browser headers so we always reach the site
"""
...
def atomic_fetch(url):
    ...
    opener.addheaders = [('User-agent', 'Mozilla/5.0')] # pretend to be browser
    try:
        fp = opener.open(url)
    ...
    except (urllib2.URLError, http.client.HTTPException, \
